...
export const projects: Project[] = [
  {
    ...
    description:
      "A collaborative visual AI workspace for turning ideas, research and content into connected, reusable workflows.",
    ownership:
      "Built the production SaaS from zero across the product interface, backend systems, AI integrations, authentication, billing, multiplayer collaboration and deployment infrastructure.",
    overview:
      "Remalt brings the messy beginning of a creative project into one visual surface: research, notes, media, AI agents and the workflows that connect them.",
    ownedDetail:
      "The work spans the part users touch and the machinery they never should have to think about: product surfaces, backend systems, identity, payments, collaboration, integrations and production operations.",
    challenges: [
    ...
    media: {
      type: "image",
      src: "/projects/remalt/remalt-temporary.webp",
      alt: "Temporary Remalt workspace composition showing linked ideas and AI workflows.",
      aspectRatio: "16 / 10",
    },
    accent: "cobalt",
  },
  {
    ...
    description:
      "An AI video repurposing platform that turns long-form recordings into editable, social-ready clips.",
    ownership:
      "Designed and built the workflow from video ingestion and transcription to AI moment selection, active-speaker tracking, reframing, caption rendering and production delivery.",
    overview:
      "GreenPost is a media pipeline with a product surface on top: long recordings become a set of editable, social-native clips without losing control over the final frame.",
    ownedDetail:
      "I owned the path from upload to delivery, including the AI decisions, active-speaker framing, browser-based rendering and the correctness checks that make a fast output trustworthy.",
    challenges: [
    ...
    highlights: [
      { label: "Measured", value: "9 clips · 8:01 → 3:43 in the tested setup." },
    ...
    media: {
      type: "image",
      src: "/projects/greenpost/greenpost-temporary.webp",
      alt: "Temporary GreenPost editing composition showing a portrait clip, active-speaker framing and caption timeline.",
      aspectRatio: "16 / 10",
    },
    accent: "moss",
  },
  {
    ...
    ownership:
      "Built the complete low-latency conversation loop and visual experience, from local speech models to the WebSocket-driven animated frontend and deployment pipeline.",
    overview:
    ...
    highlights: [
      { label: "Loop", value: "Streaming speech → response → natural voice → expression." },
    ...
    media: {
      type: "image",
      src: "/projects/project-doru/project-doru-temporary.webp",
      alt: "Temporary Project Doru composition showing a real-time avatar, waveform and local inference status.",
      aspectRatio: "16 / 10",
    },
    accent: "violet",
  },
